...
namespace flowsa\googlemapembed\fields;

use flowsa\googlemapembed\assetbundles\googlemapembedfield\GoogleMapEmbedFieldAsset;
 ...
 * @since     0.0.1
 */
class GoogleMapEmbed extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('google-map-embed', 'GoogleMapEmbed');
    }
    ...
    public function getSettingsHtml(): ?string
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'google-map-embed/_components/fields/GoogleMapEmbed_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml(mixed $value, ?\craft\base\ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(GoogleMapEmbedFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').GoogleMapEmbedGoogleMapEmbed(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'google-map-embed/_components/fields/GoogleMapEmbed_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
    ...
    {
        return \flowsa\googlemapembed\GoogleMapEmbed::$plugin->getSettings()->apiKey;
    }
